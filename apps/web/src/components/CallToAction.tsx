...
export function CallToAction() {
  return (
    <section className="py-20 md:py-32 bg-ink relative border-t border-white/5">
      <div className="container mx-auto px-6 md:px-8 lg:px-12 text-center">
        <Reveal>
          ...
          <h2 className="text-[clamp(1.875rem,6vw,2.5rem)] md:text-7xl font-serif mb-10 md:mb-12">
            Pure connection.
            <br />
            Just voice.
          </h2>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <Link
              href={routes.app}
              className="bg-white text-black px-10 md:px-12 py-4 md:py-5 rounded-full font-bold text-base md:text-lg hover:bg-accent hover:text-white transition-all"
            >
              Open RNDM App
            </Link>
            <Link
