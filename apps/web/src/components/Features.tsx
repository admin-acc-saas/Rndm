    ...
    <section id="features" className="py-40 relative">
      <div className="container mx-auto px-8 lg:px-12">
        <Reveal className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl leading-tight text-white mb-14 font-serif">
            Conversations that{" "}
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-12 items-center justify-items-center">
